...
import com.example.booktourdemo.adapters.RVChuyenDiChuaThanhToan.OnRecyclerviewItemClickListener
import com.example.booktourdemo.databinding.RvItemChuyendidathanhtoanLayoutBinding
...
class RVChuyenDiDaThanhToan(
    private val context: Context,
    private val tours: ArrayList<Tour>,
    private val bookings: ArrayList<Booking>
): RecyclerView.Adapter<RVChuyenDiDaThanhToan.MyViewHolder>() {
    ...
    inner class MyViewHolder(val binding: RvItemChuyendidathanhtoanLayoutBinding) : RecyclerView.ViewHolder(binding.root) {
        var idTour = ""
        var idSchedule = ""
        var booking = Booking()
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        val binding = RvItemChuyendidathanhtoanLayoutBinding.inflate(LayoutInflater.from(context), parent, false)
